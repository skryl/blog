...
export default ((userOpts?: Partial<NavbarOptions>) => {
  ...
  const Navbar: QuartzComponent = ({ fileData, cfg, displayClass }: QuartzComponentProps) => {
    const title = cfg?.pageTitle ?? "Origin"
      ...
      <div class={classNames(displayClass, "navbar")} id="navbar">
        <div id="navbar-left">
          <div id="title-row">
            ...
            <button id="theme-toggle" class="darkmode no-select" type="button" aria-label="Toggle theme">
              <svg
        ...
        <div id="social-links">
          ...
          <a href="https://github.com/skryl" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a href="https://skryl.substack.com" target="_blank" rel="noopener noreferrer" aria-label="Substack">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
